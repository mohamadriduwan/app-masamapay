    ...
    <div class="row h-100">
        <div class="main-container container">
            ...
            <div class="form-floating is-valid mb-3">
                ...
                <input type="text" class="form-control" name="tempat" id="tempat" value="<?= $user['name']; ?>" required>
                <label for="tempat">Nama</label>
            </div>
            <div class="form-floating is-valid mb-3">
                <input type="date" class="form-control" name="tanggal" id="tanggal" value="<?= $user['name']; ?>" required>
