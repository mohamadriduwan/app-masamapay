            ...
            <div class="card shadow-sm mb-4">
                        ...
                        <div class="row">
                            <div class="col-auto">
                                <figure class="avatar avatar-44 rounded-10">
                                    <img src="<?= base_url('assets/'); ?>/img/logo-banks/briva.png" alt="">
                                </figure>
                            </div>
                            <div class="col px-0 align-self-center">
                                <p class="mb-0 text-color-theme">BRI VA</p>
                                <p class="text size-12">MOHAMAD RIDUWAN</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="main-container container">
                    <div class="card mb-3 bg-light">
                        <div class="card-body">
                            <div class="row">
                                <div class="col align-self-center ps-0">
                                    <p style="font-size: 16px; margin-left: 12px; margin-top: 8px; margin-bottom: 8px;"><span><b id="myText">3236260010127650</b></span></p>
                                </div>
                                <div class="col-auto" style="margin-top: 8px; margin-bottom: 8px;">
                                    <center>
                                        <div class="tag bg border-danger text-white py-1 px-2">
                                            <a href="#" onclick="copyContent()" <i style="color: red;">Salin</i>
                                            </a>
                                        </div>
                                    </center>
                                </div>
                ...
                <div class="main-container container">
                    <div class="alert alert-warning ">
                        <p style="font-size: 14px; text-align: center;">Pastikan Nominal Transfer <br><strong>TEPAT BERJUMLAH ANGKA DI ATAS</strong></p>
                    </div>
                </div>
